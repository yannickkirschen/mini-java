...
public class MinijavaParser extends Parser {
	...
	public static final int
		...
		RULE_unaryOpPre = 14, RULE_unaryOpPost = 15, RULE_binaryOp = 16, RULE_args = 17, 
		RULE_literal = 18, RULE_boolean = 19, RULE_number = 20, RULE_id = 21;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "class", "var", "type", "refType", "meth", "params", "param", 
			"const", "stmt", "block", "expr", "location", "stmtExpr", "unaryOpPre", 
			"unaryOpPost", "binaryOp", "args", "literal", "boolean", "number", "id"
		};
	}
	...
	public final UnaryOpPreContext unaryOpPre() throws RecognitionException {
		...
		enterRule(_localctx, 28, RULE_unaryOpPre);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final UnaryOpPostContext unaryOpPost() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_unaryOpPost);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
