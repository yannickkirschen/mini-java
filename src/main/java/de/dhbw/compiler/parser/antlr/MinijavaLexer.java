...
public class MinijavaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "This", "Super", "Null", 
			"Incr", "Decr", "Not", "Plus", "Minus", "Mul", "Div", "Mod", "Equal", 
			"NotEqual", "Greater", "GreaterOrEqual", "Less", "LessOrEqual", "Or", 
			"And", "Int", "Bool", "Char", "String", "Void", "Boolean", "Id", "Numeral", 
			"CharValue", "StringValue", "WS", "Comment", "BlockComment"
		};
	}
